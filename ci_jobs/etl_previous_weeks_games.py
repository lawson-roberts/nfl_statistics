...
df_clean_hist = df_clean_hist.drop_duplicates(subset=['id'], keep='last').reset_index(drop=True)
...
game_scores_all = game_scores_all.drop_duplicates(subset=['id'], keep='last').reset_index(drop=True)
...
probs_historical = probs_historical.drop_duplicates(subset=['id'], keep='last').reset_index(drop=True)
